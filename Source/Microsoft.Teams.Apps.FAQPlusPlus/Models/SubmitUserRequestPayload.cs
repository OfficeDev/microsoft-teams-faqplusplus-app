...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Models
{
    ...
    public class SubmitUserRequestPayload
    {
        ...
        /// </summary>
        public string AppFeedback { get; set; } = Resource.NonApplicableString;
        ...
        /// </summary>
        public string UserQuestion { get; set; } = Resource.NonApplicableString;

        /// <summary>
        /// Gets or sets the question for the expert being asked by the user through bot command.
        /// </summary>
        public string QuestionForExpert { get; set; } = Resource.NonApplicableString;
        ...
        /// </summary>
        public string SmeAnswer { get; set; } = Resource.NonApplicableString;

        /// <summary>
        /// Gets or sets the results feedback.
        /// </summary>
        public string ResultsFeedback { get; set; } = Resource.NonApplicableString;
